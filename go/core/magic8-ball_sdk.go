...
func (sdk *Magic8BallSDK) OptionsMap() map[string]any {
...
func (sdk *Magic8BallSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *Magic8BallSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *Magic8BallSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Magic8BallSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *Magic8BallSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *Magic8BallSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("Magic8BallSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *Magic8BallSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Magic8BallSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("Magic8BallSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
