...
const testSeed = `map[string]any{"entity": map[string]any{"biased": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "category": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "category_fortune": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "random_fortune": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
