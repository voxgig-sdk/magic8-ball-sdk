...
func NewCategoryFortuneEntity(client *core.Magic8BallSDK, entopts map[string]any) *CategoryFortuneEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CategoryFortuneEntity) GetName() string { return e.name }
...
func (e *CategoryFortuneEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CategoryFortuneEntity) Deleted() bool {
	return e.deleted
}


func (e *CategoryFortuneEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCategoryFortuneEntity(e.client, opts)
}

func (e *CategoryFortuneEntity) Data(args ...any) any {
...
func (e *CategoryFortuneEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CategoryFortune; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CategoryFortuneEntity) DataTyped(data ...CategoryFortune) CategoryFortune {
	if len(data) > 0 {
		return typedFrom[CategoryFortune](e.Data(asMap(data[0])))
	}
	return typedFrom[CategoryFortune](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CategoryFortune (all fields
// optional at the wire level).
func (e *CategoryFortuneEntity) MatchTyped(match ...CategoryFortune) CategoryFortune {
	if len(match) > 0 {
		return typedFrom[CategoryFortune](e.Match(asMap(match[0])))
	}
	return typedFrom[CategoryFortune](e.Match())
}
...
func (e *CategoryFortuneEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CategoryFortuneEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CategoryFortuneLoadMatch and returns an CategoryFortune. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CategoryFortuneEntity) LoadTyped(reqmatch CategoryFortuneLoadMatch, ctrl map[string]any) (CategoryFortune, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CategoryFortune{}, err
	}
	return typedFrom[CategoryFortune](res), nil
}



func (e *CategoryFortuneEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CategoryFortuneEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CategoryFortuneEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CategoryFortuneEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CategoryFortuneEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
