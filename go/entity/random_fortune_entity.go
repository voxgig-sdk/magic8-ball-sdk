...
type RandomFortuneEntity struct {
	name    string
...
func NewRandomFortuneEntity(client *core.Magic8BallSDK, entopts map[string]any) *RandomFortuneEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RandomFortuneEntity) GetName() string { return e.name }
...
func (e *RandomFortuneEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RandomFortuneEntity) Deleted() bool {
	return e.deleted
}


func (e *RandomFortuneEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRandomFortuneEntity(e.client, opts)
}

func (e *RandomFortuneEntity) Data(args ...any) any {
...
func (e *RandomFortuneEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RandomFortune; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RandomFortuneEntity) DataTyped(data ...RandomFortune) RandomFortune {
	if len(data) > 0 {
		return typedFrom[RandomFortune](e.Data(asMap(data[0])))
	}
	return typedFrom[RandomFortune](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RandomFortune (all fields
// optional at the wire level).
func (e *RandomFortuneEntity) MatchTyped(match ...RandomFortune) RandomFortune {
	if len(match) > 0 {
		return typedFrom[RandomFortune](e.Match(asMap(match[0])))
	}
	return typedFrom[RandomFortune](e.Match())
}
...
func (e *RandomFortuneEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RandomFortuneEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RandomFortuneEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RandomFortuneEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RandomFortuneEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RandomFortuneEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RandomFortuneEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
