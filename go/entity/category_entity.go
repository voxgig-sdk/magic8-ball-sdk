...
func NewCategoryEntity(client *core.Magic8BallSDK, entopts map[string]any) *CategoryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CategoryEntity) GetName() string { return e.name }
...
func (e *CategoryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CategoryEntity) Deleted() bool {
	return e.deleted
}


func (e *CategoryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCategoryEntity(e.client, opts)
}

func (e *CategoryEntity) Data(args ...any) any {
...
func (e *CategoryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Category; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CategoryEntity) DataTyped(data ...Category) Category {
	if len(data) > 0 {
		return typedFrom[Category](e.Data(asMap(data[0])))
	}
	return typedFrom[Category](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Category (all fields
// optional at the wire level).
func (e *CategoryEntity) MatchTyped(match ...Category) Category {
	if len(match) > 0 {
		return typedFrom[Category](e.Match(asMap(match[0])))
	}
	return typedFrom[Category](e.Match())
}
...
func (e *CategoryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CategoryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CategoryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CategoryListMatch and returns []Category. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CategoryEntity) ListTyped(reqmatch CategoryListMatch, ctrl map[string]any) ([]Category, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Category](res), nil
}



func (e *CategoryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CategoryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CategoryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CategoryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
