...
func NewBiasedEntity(client *core.Magic8BallSDK, entopts map[string]any) *BiasedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BiasedEntity) GetName() string { return e.name }
...
func (e *BiasedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BiasedEntity) Deleted() bool {
	return e.deleted
}


func (e *BiasedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBiasedEntity(e.client, opts)
}

func (e *BiasedEntity) Data(args ...any) any {
...
func (e *BiasedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *BiasedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BiasedEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BiasedEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *BiasedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BiasedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BiasedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
