...
describe("CategoryDirect", function()
  it("should direct-list-category", function()
    local setup = category_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-category", setup.live and "live" or "unit")
...
function category_direct_setup(mockres)
