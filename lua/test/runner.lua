...
function runner.env_override(m)
  local live = runner.getenv("MAGIC8_BALL_TEST_LIVE")
  local override = runner.getenv("MAGIC8_BALL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MAGIC8_BALL_TEST_EXPLAIN")
