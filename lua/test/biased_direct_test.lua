...
describe("BiasedDirect", function()
  it("should direct-load-biased", function()
    local setup = biased_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-biased", setup.live and "live" or "unit")
...
function biased_direct_setup(mockres)
