...
local SDK_MODULE = "magic8-ball_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["biased"] = { ["test01"] = { id = "test01" } }, ["category"] = { ["test01"] = { id = "test01" } }, ["category_fortune"] = { ["test01"] = { id = "test01" } }, ["random_fortune"] = { ["test01"] = { id = "test01" } } } }'
