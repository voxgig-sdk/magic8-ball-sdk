...
describe("CategoryFortuneDirect", function()
  it("should direct-load-category_fortune", function()
    local setup = category_fortune_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-category_fortune", setup.live and "live" or "unit")
...
function category_fortune_direct_setup(mockres)
