...
local Magic8BallSDK = {}
Magic8BallSDK.__index = Magic8BallSDK
...
Magic8BallSDK._make_feature = _make_feature


function Magic8BallSDK.new(options)
  local self = setmetatable({}, Magic8BallSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function Magic8BallSDK:options_map()
...
function Magic8BallSDK:get_utility()
  return Utility.copy(self._utility)
end


function Magic8BallSDK:get_root_ctx()
  return self._rootctx
end


function Magic8BallSDK:prepare(fetchargs)
...
function Magic8BallSDK:direct(fetchargs)
...
-- by passing it.
function Magic8BallSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function Magic8BallSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "Magic8BallSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function Magic8BallSDK.test(testopts, sdkopts)
  ...
  local sdk = Magic8BallSDK.new(sdkopts)
  sdk.mode = "test"
