...
class CategoryDirectTest extends TestCase
{
    public function test_direct_list_category(): void
    {
        $setup = category_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-category", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
