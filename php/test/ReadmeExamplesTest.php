...
// Magic8Ball SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (Magic8BallSDK::test)
...
{
    private const SDK_CLASS = 'Magic8BallSDK';
    ...
    private const SDK_BASE = 'magic8ball_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../magic8ball_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
