...
{
    private static function utility(): Magic8BallUtility
    {
        return new Magic8BallUtility();
    }
    ...
    private static function ctx(array $over = []): Magic8BallContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new Magic8BallContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new Magic8BallOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof Magic8BallError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new Magic8BallOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = Magic8BallMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new Magic8BallOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = Magic8BallMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new Magic8BallOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = Magic8BallMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Magic8BallSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = Magic8BallMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new Magic8BallResponse([]),
            'result' => new Magic8BallResult([]),
        ]);
        [, $err] = Magic8BallMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new Magic8BallSpec([]),
            'response' => null,
            'result' => new Magic8BallResult([]),
        ]);
        [, $err] = Magic8BallMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new Magic8BallSpec(['step' => 's']),
            'response' => new Magic8BallResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new Magic8BallResult([]),
        ]);
        [, $err] = Magic8BallMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new Magic8BallSpec(['step' => 's']),
            'response' => new Magic8BallResponse(self::resp(200, ['v' => 1])),
            'result' => new Magic8BallResult([]),
        ]);
        [, $err] = Magic8BallMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new Magic8BallSpec(['step' => 's']),
            'response' => new Magic8BallResponse(self::resp(200, ['v' => 2])),
            'result' => new Magic8BallResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        Magic8BallMakeResponse::call($ctx);
    ...
    {
        $preset = new Magic8BallResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new Magic8BallSpec([]),
            'response' => new Magic8BallResponse([]),
            'result' => new Magic8BallResult([]),
        ...
        [$got, $err] = Magic8BallMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new Magic8BallResult([])]);
        [, $err] = Magic8BallMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new Magic8BallSpec([]), 'result' => null]);
        [, $err] = Magic8BallMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Magic8BallSpec(['step' => 's']),
            'result' => new Magic8BallResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new Magic8BallOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Magic8BallMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Magic8BallSpec(['step' => 's']),
            'result' => new Magic8BallResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new Magic8BallOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Magic8BallMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Magic8BallResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new Magic8BallSpec([]),
            'result' => new Magic8BallResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = Magic8BallMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Magic8BallMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new Magic8BallError('boom', 'boom');
        $utility->fetcher = function (Magic8BallContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Magic8BallSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = Magic8BallMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (Magic8BallContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = Magic8BallMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(Magic8BallResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        Magic8BallMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (Magic8BallContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Magic8BallSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = Magic8BallMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new Magic8BallResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new Magic8BallSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = Magic8BallMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = Magic8BallMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = Magic8BallMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new Magic8BallResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, Magic8BallDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new Magic8BallResult(['ok' => false])]);
        $this->expectException(Magic8BallError::class);
        Magic8BallDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new Magic8BallResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', Magic8BallMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        Magic8BallMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new Magic8BallBaseFeature();
        $b = new Magic8BallBaseFeature();
        Magic8BallFeatureAdd::call($ctx, $a);
        Magic8BallFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): Magic8BallBaseFeature
    {
        $f = new Magic8BallBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        Magic8BallFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): Magic8BallContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new Magic8BallSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Magic8BallPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        Magic8BallPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new Magic8BallResponse(['headers' => null]),
            'result' => new Magic8BallResult([]),
        ]);
        Magic8BallResultHeaders::call($ctx);
