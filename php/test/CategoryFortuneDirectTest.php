...
class CategoryFortuneDirectTest extends TestCase
{
    public function test_direct_load_category_fortune(): void
    {
        $setup = category_fortune_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-category_fortune", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
