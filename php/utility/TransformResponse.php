...
// Magic8Ball SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class Magic8BallTransformResponse
{
    public static function call(Magic8BallContext $ctx): mixed
    {
        ...
        $transform = Magic8BallHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
