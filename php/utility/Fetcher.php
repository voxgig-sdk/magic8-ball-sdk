...
// Magic8Ball SDK utility: fetcher

class Magic8BallFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; Magic8BallSDK/1.0)';
    ...
    public static function call(Magic8BallContext $ctx, string $fullurl, array $fetchdef): array
    {
