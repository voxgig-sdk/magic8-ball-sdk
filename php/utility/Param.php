...
// Magic8Ball SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class Magic8BallParam
{
    public static function call(Magic8BallContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = Magic8BallHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
