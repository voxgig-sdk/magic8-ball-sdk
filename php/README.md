...
The PHP SDK for the Magic8Ball API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Biased(null)->load(["id" => "example_id"], null);
...
```php
// Create
[$created, $_] = $client->Biased(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->Magic8Ball(null)->load(
    ["id" => "test01"], null
);
