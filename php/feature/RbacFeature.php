...
class Magic8BallRbacFeature extends Magic8BallBaseFeature
{
    ...
    private function _required(Magic8BallContext $ctx): ?string
    {
    ...
    private function _reject(Magic8BallContext $ctx, string $required): void
    {
    ...
    private function _track(Magic8BallContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
