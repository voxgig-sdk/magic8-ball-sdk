...
// Magic8Ball SDK idempotency feature
...
class Magic8BallIdempotencyFeature extends Magic8BallBaseFeature
{
    ...
    private function _mutating(Magic8BallContext $ctx): bool
    {
