...
// Magic8Ball SDK streaming feature
...
class Magic8BallStreamingFeature extends Magic8BallBaseFeature
{
    ...
    private function _iterate(Magic8BallResult $result): \Generator
    {
    ...
    private function _streamable(Magic8BallContext $ctx): bool
    {
