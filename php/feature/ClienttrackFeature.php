...
// Magic8Ball SDK clienttrack feature
...
class Magic8BallClienttrackFeature extends Magic8BallBaseFeature
{
    ...
    public function PostConstruct(Magic8BallContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Magic8Ball-SDK';
