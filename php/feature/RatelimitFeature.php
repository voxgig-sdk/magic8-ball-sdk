...
// Magic8Ball SDK ratelimit feature
...
class Magic8BallRatelimitFeature extends Magic8BallBaseFeature
{
    ...
    private function _acquire(Magic8BallContext $ctx): void
    {
    ...
    private function _track(Magic8BallContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
