...
// Magic8Ball SDK Category entity
...
class CategoryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CategoryEntity($this->_client, $opts);
    }

    /**
     * @param Category|array $args Category data (assoc-array) to store.
     */
    ...
    /**
     * @return Category|array The current Category data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Category fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Category fields).
     */
    ...
    /**
     * List Category items matching the given filter.
     *
     * @param CategoryListMatch|array|null $reqmatch Match filter (any subset
     *   of Category fields) as an assoc-array; CategoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Category[]|array A list of Category items as assoc-arrays at
     *   the SDK boundary; throws Magic8BallError on failure (item-5 convention).
     */
