...
from magic8ball_sdk.core.helpers import get_ctx_prop, to_map
...
class Magic8BallContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, Magic8BallSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, Magic8BallResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, Magic8BallResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return Magic8BallError(code, msg, self)
