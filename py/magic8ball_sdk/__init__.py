...
from magic8ball_sdk.utility import register

# Load features
from magic8ball_sdk.feature.base_feature import Magic8BallBaseFeature
from magic8ball_sdk.features import _has_feature, _make_feature
...
class Magic8BallSDK:
    ...
    def get_utility(self):
        return Magic8BallUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("Magic8BallSDK: graphql: " + str(msg))
            res["graphql"] = errors
