...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Biased()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/magic8-ball-sdk/releases)) or
...
```
py/
├── magic8ball_sdk.py         -- Main SDK module
