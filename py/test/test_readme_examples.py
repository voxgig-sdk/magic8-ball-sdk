# Magic8Ball SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions Magic8BallSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both Magic8BallSDK(...) and Magic8BallSDK.test(...) become
#      Magic8BallSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "magic8ball_sdk"
_SDK_CLASS = "Magic8BallSDK"
