...
class Magic8BallTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = Magic8BallTestRunner.getenv("MAGIC8BALL_TEST_LIVE")
        override = Magic8BallTestRunner.getenv("MAGIC8BALL_TEST_OVERRIDE")
        ...
        explain = Magic8BallTestRunner.getenv("MAGIC8BALL_TEST_EXPLAIN")
