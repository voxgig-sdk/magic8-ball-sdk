...
|---|---|---|
| `ts/` | @voxgig-sdk/magic8-ball-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/magic8-ball-sdk \
      --repository voxgig-sdk/magic8-ball-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/magic8-ball-sdk` shows it, and
`npm trust revoke @voxgig-sdk/magic8-ball-sdk --id=<id>` removes it.
