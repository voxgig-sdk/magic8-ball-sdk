...
class Magic8BallTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = Magic8BallTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = Magic8BallTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = Magic8BallTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
