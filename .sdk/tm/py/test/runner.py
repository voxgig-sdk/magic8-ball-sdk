...
class Magic8BallTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = Magic8BallTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = Magic8BallTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = Magic8BallTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
