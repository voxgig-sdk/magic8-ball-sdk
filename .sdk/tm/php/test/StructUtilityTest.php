...
// Magic8Ball SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = Magic8BallOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(Magic8BallOmni::structfix($now, Struct::undef()))
                        !== json_encode(Magic8BallOmni::structfix($val, Struct::undef()))) {
