...
class Magic8BallProxyFeature extends Magic8BallBaseFeature
{
    ...
    public function init(Magic8BallContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (Magic8BallContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
