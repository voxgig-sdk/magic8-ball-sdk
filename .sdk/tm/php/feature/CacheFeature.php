...
class Magic8BallCacheFeature extends Magic8BallBaseFeature
{
    ...
    private function _through(Magic8BallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
