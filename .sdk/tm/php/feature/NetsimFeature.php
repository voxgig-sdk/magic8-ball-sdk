...
class Magic8BallNetsimFeature extends Magic8BallBaseFeature
{
    ...
    private function _simulate(Magic8BallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(Magic8BallContext $ctx, array $applied): void
    {
        $client = $this->client;
