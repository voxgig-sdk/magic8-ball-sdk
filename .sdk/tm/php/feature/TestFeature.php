...
// Magic8Ball SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class Magic8BallTestFeature extends Magic8BallBaseFeature
{
    ...
    public function init(Magic8BallContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (Magic8BallContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = Magic8BallParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (Magic8BallContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(Magic8BallContext $ctx, $op, $args): array
    {
