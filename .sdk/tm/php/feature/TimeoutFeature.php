...
// Magic8Ball SDK timeout feature
...
class Magic8BallTimeoutFeature extends Magic8BallBaseFeature
{
    ...
    private function _with_timeout(Magic8BallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(Magic8BallContext $_ctx, float $ms): void
    {
        $client = $this->client;
