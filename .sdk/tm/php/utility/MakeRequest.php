...
// Magic8Ball SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class Magic8BallMakeRequest
{
    public static function call(Magic8BallContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new Magic8BallResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new Magic8BallResponse($fetched);
        } else {
