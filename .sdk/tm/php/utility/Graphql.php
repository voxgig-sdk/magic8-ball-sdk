...
// Magic8Ball SDK utility: graphql
//
...
class Magic8BallGraphql
{
    ...
    // equivalent.
    public static function body(Magic8BallContext $ctx): mixed
    {
    ...
    public static function errors(Magic8BallContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
