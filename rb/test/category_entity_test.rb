...
class CategoryEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = Magic8BallSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MAGIC8_BALL_TEST_CATEGORY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def category_basic_setup(extra)
  ...
  entid_env_raw = ENV["MAGIC8_BALL_TEST_CATEGORY_ENTID"]
