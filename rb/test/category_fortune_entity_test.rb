...
class CategoryFortuneEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MAGIC_BALL_TEST_CATEGORY_FORTUNE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def category_fortune_basic_setup(extra)
  ...
  entid_env_raw = ENV["MAGIC_BALL_TEST_CATEGORY_FORTUNE_ENTID"]
