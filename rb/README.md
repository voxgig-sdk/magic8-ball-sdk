...
The Ruby SDK for the Magic8Ball API — an entity-oriented client using idiomatic Ruby conventions.
...
```
rb/
├── Magic8Ball_sdk.rb       -- Main SDK module
...
The main module (`Magic8Ball_sdk`) exports the SDK class
