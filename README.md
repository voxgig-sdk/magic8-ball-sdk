...
This is an unofficial SDK for the Magic 8-Ball public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/magic8-ball` | `npm install @voxgig-sdk/magic8-ball` |
| Python | `voxgig-sdk-magic8-ball` | `pip install voxgig-sdk-magic8-ball` |
| PHP | `voxgig-sdk/magic8-ball` | `composer require voxgig-sdk/magic8-ball` |
| Golang | `github.com/voxgig-sdk/magic8-ball-sdk/go` | `go get github.com/voxgig-sdk/magic8-ball-sdk/go` |
| Ruby | `voxgig-sdk-magic8-ball` | `gem install voxgig-sdk-magic8-ball` |
| Lua | `voxgig-sdk-magic8-ball` | `luarocks install voxgig-sdk-magic8-ball` |
