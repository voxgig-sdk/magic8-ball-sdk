...
The Magic 8-Ball API provides mystical yes/no responses to user questions through a simple, RESTful interface.

Learn more about Magic 8-Ball API at [www.eightballapi.com/docs](https://www.eightballapi.com/docs).
...
const biased = await client.Biased().load({ question: "example" })
```
