...
function envOverride(m) {
    if ('TRUE' === process.env.MAGIC8_BALL_TEST_LIVE ||
        'TRUE' === process.env.MAGIC8_BALL_TEST_OVERRIDE) {
    ...
    m.MAGIC8_BALL_TEST_EXPLAIN = process.env.MAGIC8_BALL_TEST_EXPLAIN || m.MAGIC8_BALL_TEST_EXPLAIN;
    return m;
}
