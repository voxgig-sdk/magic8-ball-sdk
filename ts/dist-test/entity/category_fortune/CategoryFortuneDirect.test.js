...
(0, node_test_1.describe)('CategoryFortuneDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.Magic8BallSDK({
    ...
    (0, node_test_1.test)('direct-load-category_fortune', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-category_fortune', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["category01"]))
            return;
...
function liveScenariosActive() { return false && process.env.MAGIC8_BALL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'MAGIC8_BALL_TEST_CATEGORY_FORTUNE_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.Magic8BallSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MAGIC8_BALL_TEST_CATEGORY_FORTUNE_ENTID'];
    ...
    const client = new __1.Magic8BallSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CategoryFortuneDirect.test.js.map