...
(0, node_test_1.describe)('CategoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-category', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-category', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAGIC8_BALL_TEST_CATEGORY_ENTID'];
...
//# sourceMappingURL=CategoryDirect.test.js.map