...
(0, node_test_1.describe)('BiasedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-biased', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-biased', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MAGIC8_BALL_TEST_BIASED_ENTID'];
...
//# sourceMappingURL=BiasedDirect.test.js.map