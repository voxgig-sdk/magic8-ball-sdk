...
(0, node_test_1.describe)('RandomFortuneEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'random_fortune.' + op, live))
                return;
        }
        ...
        let random_fortune_ref01_data = Object.values(setup.data.existing.random_fortune)[0];
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/random_fortune/RandomFortuneTestData.json');
    ...
    let idmap = transform(['random_fortune01', 'random_fortune02', 'random_fortune03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=RandomFortuneEntity.test.js.map