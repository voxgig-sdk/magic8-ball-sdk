...
class CategoryEntity extends Magic8BallEntityBase_1.Magic8BallEntityBase {
    ...
    make() {
        return new CategoryEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Category[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
