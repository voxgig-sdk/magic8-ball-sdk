...
AQL-driven CLI and REPL for the Magic8Ball SDK. Positional arguments are
...
./magic8-ball-cli list biased
./magic8-ball-cli load 1 biased
./magic8-ball-cli load '{id:1}' biased
