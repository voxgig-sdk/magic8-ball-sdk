...
type Args struct {
	Entity string         `json:"entity" jsonschema:"biased | category | category_fortune | random_fortune"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.Magic8BallSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "magic8-ball_list",
		Description: "List records from Magic8Ball. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "magic8-ball_load",
		Description: "Load a single record from Magic8Ball. " +
...
func runOp(client *sdk.Magic8BallSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.Magic8BallSDK, name string) (sdk.Magic8BallEntity, error) {
	switch strings.ToLower(name) {
	case "biased":
		return client.Biased(nil), nil
	case "category":
